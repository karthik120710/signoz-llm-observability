...
/**
 * Hooks for BudgetAlert routes
 */
export interface BudgetAlertHooks {
  /**
...
/**
 * Default BudgetAlert hooks (customize as needed)
 */
export const budgetAlertHooks: BudgetAlertHooks = {
