...
/**
 * Hooks for SigNozConfig routes
 */
export interface SigNozConfigHooks {
  /**
...
/**
 * Default SigNozConfig hooks (customize as needed)
 */
export const sigNozConfigHooks: SigNozConfigHooks = {
