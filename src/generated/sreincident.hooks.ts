...
/**
 * Hooks for SREIncident routes
 */
export interface SREIncidentHooks {
  /**
...
/**
 * Default SREIncident hooks (customize as needed)
 */
export const sREIncidentHooks: SREIncidentHooks = {
